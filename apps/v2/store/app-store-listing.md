...
A to-do list that remembers when you last touched long-term projects.
...
Check-ins has accounts for syncing your own data across devices. It has no payments and no ads.

## Keywords

projects, tasks, todo, reminders, productivity, check-ins, habits
...
Check-ins has no payments, no subscriptions, and no ads. Accounts are used only for user-owned data sync.

Provide reviewers a demo account after the production Supabase project is configured.
